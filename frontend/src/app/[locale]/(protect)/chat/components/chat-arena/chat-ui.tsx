...
import { CopyButton } from '@/registry/new-york-v4/ui/copy-button';
import { MessageInput } from '@/registry/new-york-v4/ui/message-input';
import { MessageList } from '@/registry/new-york-v4/ui/message-list';
import { PromptSuggestions } from '@/registry/new-york-v4/ui/prompt-suggestions';
...
export const ChatContainer = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => {
        return (
            <div ref={ref} className={cn('grid max-h-full w-full grid-rows-[1fr_auto] pt-2', className)} {...props} />
        );
    }
);
