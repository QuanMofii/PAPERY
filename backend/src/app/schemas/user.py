...
class UserUpdate(BaseModel):
    ...
    name: Annotated[str | None, Field(min_length=2, max_length=30, examples=["User Example"], default=None)]
    username: Annotated[
        str | None, Field(min_length=2, max_length=20, pattern=r"^[a-z0-9]+$", examples=["userberg"], default=None)
    ]
    email: Annotated[EmailStr | None, Field(examples=["userg@example.com"], default=None)]
